...
<body style="background-image: url('assets/img/16332345_rm347-baifernn-07.jpg');background-size: 1920px 960px;">
                ...
                <main>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg" style="margin-top: 40%;">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button class="btn btn-secondary" type="submit" name="login" value="login" href="index.html">Login</button>
